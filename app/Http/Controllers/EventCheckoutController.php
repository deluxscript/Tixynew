...
class EventCheckoutController extends Controller
{
    ...
    public function postValidateTickets(Request $request, $event_id)
    {
        ...
        session()->set('ticket_order_' . $event->id, [
            ...
            'account_payment_gateway' => count((array)$event->account->active_payment_gateway) ? $event->account->active_payment_gateway : false,
            'payment_gateway'         => count((array)$event->account->active_payment_gateway) ? $event->account->active_payment_gateway->payment_gateway : false,
        ]);
