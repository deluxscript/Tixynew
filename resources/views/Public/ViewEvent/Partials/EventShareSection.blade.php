        ...
        <div class="col-md-12">
            <ul class="rrssb-buttons clearfix">
                ...
                <li class="rrssb-facebook">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=http://artxlagos.com/the-programme" class="popup">
                ...
                <li class="rrssb-twitter">
                    <a href="http://twitter.com/intent/tweet?text=Check out: http://artxlagos.com/the-programme {{{Str::words(strip_tags($event->description), 20)}}}" class="popup">
                        <span class="rrssb-icon">
