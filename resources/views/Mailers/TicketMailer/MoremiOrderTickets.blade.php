          ...
          <table cellpadding="0" cellspacing="0" style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif;border-collapse: collapse;width: 100%;-premailer-cellpadding: 0;-premailer-cellspacing: 0;">
            <tr>
              <td class="content" style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif;padding: 40px 48px;">
                <p style="line-height: 1.5; font-size: 16px; text-align: center;"><b>The Moremi Ticket</b></p>
                                   
                <p style="line-height: 1.5; font-size: 16px; text-align: center;"><b>You’ll be taking SLAY Festival to the world, Moremi
                    </b></p>
                <p style="line-height: 1.5; font-size: 16px;">
                        Just like Princess Moremi brought the secrets of the rival tribe to her Yoruba people that helped them win the war, you’ll be taking the secrets of SLAY Festival to the world!
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                        Here’s your press ticket to SLAY Festival! Please have it available on your phone for quick check in at the SLAY Festival venue.   
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                        Follow our Instagram page <a href="Instagram.com/SLAYFestival">@SLAYFestival</a> for special announcements and don’t forget to use the hashtag #SLAYFestival2019 on all your SLAY Festival related posts! We can’t wait to see you on the 28th of September. Let’s do this! 
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                        For follow-up questions, please reach out to your press coordinator.
                <p/>
              </td>
            </tr>
            <tr>
