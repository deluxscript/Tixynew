          ...
          <table cellpadding="0" cellspacing="0" style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif;border-collapse: collapse;width: 100%;-premailer-cellpadding: 0;-premailer-cellspacing: 0;">
            <tr>
              <td class="content" style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif;padding: 40px 48px;">
                <p style="line-height: 1.5; font-size: 16px; text-align: center;"><b>The Nehanda Ticket</b></p>
                                   
                <p style="line-height: 1.5; font-size: 16px; text-align: center;"><b> 5000 women are ready to be inspired by you, Nehanda.
                    </b></p>
                <p style="line-height: 1.5; font-size: 16px;">
                    Nehanda Charwe, a fearless, natural born leader…
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                    As a speaker at SLAY Festival 2019, we trust that you will embody the values of this ancient Zimbabwean warrior-hero in bringing forth knowledge, understanding and a new perspective to the thousands of SLAY Festival attendees who cannot wait to meet you.  
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                    This is your official ticket to the event. Please have it available on your phone for quick check in via the speakers line. 
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                        Please follow our Instagram page <a href="Instagram.com/SLAYFestival">@SLAYFestival</a> for special announcements and don’t forget to use the hashtag #SLAYFestival2019 on all your SLAY Festival related posts!
                <p/>
                <p style="line-height: 1.5; font-size: 16px;">
                        We can’t wait to see you on the 28th of September! 
                <p/>
              </td>
            </tr>
            <tr>
