...
@section('message_content')
    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td>
                    ...
                    <div class="message">
                        ...
                        You have been invited {{$attendee->order->event->title}} to attend the 2018 edition of ART X Lagos, happening from the 3rd to 4th of November
                        2018.
                        <br>
            ...
            <tr>
                <td>
                    <a class="message" style="color: #1756E5;" href="{!! route('downloadCalendarIcs', ['event_id' => $attendee->order->event->id]) !!}">Add to calendar</a>
