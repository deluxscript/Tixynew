        ...
        <tr>
            <td>
                            <div class="message">
                                ...
                                Thank you for purchasing your {{$order->event->title}} Ticket(s) to attend the 2018 edition of ART X Lagos, happening from the 3rd to 4th of November
                                2018.
                                <br>
                    ...
                    <tr>
                        <td>
                            ...
                            <p class="message">Please note that:</p>
